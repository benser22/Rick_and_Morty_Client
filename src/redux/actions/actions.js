...
export const loadFavorites = () => {
  const endpoint = "https://rick-and-morty-server-ny1slps2e-benser22.vercel.app/rickandmorty/fav"; 
...
export const removeFav = (id) => {
  const endpoint = "https://rick-and-morty-server-ny1slps2e-benser22.vercel.app/rickandmorty/fav/" + id;
  return async (dispatch) => {
    try {
